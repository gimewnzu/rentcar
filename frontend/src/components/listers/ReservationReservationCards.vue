<template>
    <div>
        ...
        >
            <v-row>
                <v-list-item class="d-flex">
                    ...
                    <h1 class="align-self-center ml-3">Reservation</h1>
        ...
        <v-row>
            <ReservationReservation :offline="offline" class="video-card" v-for="(value, index) in values" v-model="values[index]" v-bind:key="index" @delete="remove"/>
        </v-row>
    </div>
</template>
